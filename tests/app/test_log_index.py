...
class LogIndexTestCase(testing.TestCase):
    ...
    def test_with_style_(self):
        response = self.client.get(url_for('_log_index', style=""))
        self.assert400(response)

    def test_with_style_abc(self):
        response = self.client.get(url_for('_log_index', style="abc"))
        self.assert400(response)

    def test_with_style_default(self):
        response = self.client.get(url_for('_log_index', style="default"))
        self.assert200(response)
        self.assertTemplateUsed('log_index.html')

    def test_with_style_dark(self):
        response = self.client.get(url_for('_log_index', style="dark"))
        self.assert200(response)
        self.assertTemplateUsed('log_index.html')
